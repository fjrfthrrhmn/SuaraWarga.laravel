...
const TitleList = ({ ...props }: TitleListProps) => {
    ...
    return (
        <div className="flex justify-between items-center">
            <Typography.Title variant="4/bold">{title}</Typography.Title>
            <Typography.Text variant="sm/normal" className="group">
                <Link href={url} className="decoration-2 underline underline-offset-8 text-foreground flex gap-2 items-end">
